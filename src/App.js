          ...
          <div style={{ padding: 30, minHeight: 410 }}>
            ...
            {tab === "main" && (
              <div>
                ...
                <div style={{ marginBottom: 30 }}>
                  {fakeCards.map((card, idx) => (
                    ...
                    >
                        ...
                        {card.chip && (
                          <span
                            style={{
                              ...
                              height: 13,
                              background:
                                "linear-gradient(150deg,#fffae4,#cfcfcf 80%)",
                              borderRadius: 4,
                              marginRight: 8,
                              border: "1px solid #d9d5b1",
                              boxShadow: "0 0 2px #fff9"
                            }}
                          ></span>
                        )}
                        {card.type}
                      ...
                      >
                        <div style={{ fontSize: 12, color: "#f4f6fa" }}>
                          Срок: {card.expiry}
                        </div>
                        <div
                          style={{
                ...
                <div style={{ fontSize: 13, color: "#b4b8cb", marginTop: 22 }}>
                  Ваши деньги под надёжной защитой
                  <br />
                  ...
                  >
                    <div
                      style={{
                        fontWeight: 700,
                        color:
                          item.status === "success" ? "#50bb61" : "#b2a14e",
                        fontSize: 17,
                        marginRight: 18,
                        minWidth: 32,
                        textAlign: "center"
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ fontSize: 13.5, color: "#b1b1be" }}>
                        {item.desc}
                      </div>
                    </div>
                    <div
            ...
            {tab === "analytics" && (
              <div>
                ...
                >
                  Аналитика за {fakeAnalytics.month}
                </div>
                <div
                  style={{
                    display: "flex",
                ...
                >
                  ...
                  >
                    ...
                    >
                      +{fakeAnalytics.income} ₽
                    </div>
                    <div style={{ fontSize: 13, color: "#b4b8cb" }}>
                      Поступления
                    </div>
                  </div>
                  <div
                ...
                >
                  ...
                  <br />
                  автоматически сортируются по категориям
                </div>
              </div>
            )}
            ...
            {tab === "profile" && (
              <div style={{ textAlign: "center", paddingTop: 10 }}>
                ...
                >
                  Кошелек работает с 2024 года
                  <br />
                  <span style={{ fontWeight: 700, color: "#6d4aff" }}>
                    Премиум
                  </span>{" "}
                  поддержка и максимальная защита.
                </div>
              </div>
            )}
          </div>
